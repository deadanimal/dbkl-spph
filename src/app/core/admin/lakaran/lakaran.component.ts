...
@Component({
  selector: 'app-lakaran',
  templateUrl: './lakaran.component.html',
  styleUrls: ['./lakaran.component.scss']
})
export class LakaranComponent implements AfterViewInit {
  ...
  getChart() {
    let chart = am4core.create("lakaranchartdiv", am4charts.XYChart);
  ...
  getChart1() {
    let chart = am4core.create("lakaranchartdiv1", am4charts.XYChart);
